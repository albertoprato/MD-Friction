...
\begin{document}
	...
	\begin{description}
		...
		Initializes the solvent velocities from the Maxwell distribution at a target temperature. To ensure the reference frame remains inertial, the module explicitly removes any net center-of-mass drift resulting from the stochastic sampling.
