...
\begin{document}
	...
	The initial configuration must be provided in standard XYZ format, typically generated by software like Packmol. The file format is rigid and must adhere to the specific line order described below.
