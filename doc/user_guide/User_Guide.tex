...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{@{}llp{8cm}@{}}
			...
			1 & \texttt{n}, \texttt{dt} & total number of steps and time step \\[5pt]
	...
	\begin{itemize}
		\item \textbf{\texttt{trajectory.xyz}}: contains the atomic coordinates of the system at regular intervals (every 100 steps) during the simulation. This file is compatible with visualization software such as VMD.
